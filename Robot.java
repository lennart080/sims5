...
public class Robot {
  ...
  private double[][] neurons = new double[3][];   //[] reihe [][] neuron   //55555555555555555555555 in first
  ...
  public Robot(Manager pManager, int[] pDna, double[] pPosition) {
    ...
    //---------------------------------
    neurons[0] = new double[2];
    neurons[1] = new double[2];
    neurons[2] = new double[1];
    //---------------------------------
    /* 
  ...
  public void calculate() {
    ...
    System.out.println("1: " + neurons[2][0]);
  }
}